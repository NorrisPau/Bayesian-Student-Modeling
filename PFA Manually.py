...
full_data = pd.read_csv("https://raw.githubusercontent.com/theophilee/learner-performance-prediction/master/data/bridge_algebra06/preprocessed_data.csv", sep="\t")
print(full_data)
...
#Based on prior sucesses or prior failures we want to predict if correct = 1/0 in current row
#TODO: Question - How to run a logistic regression per student and per skill?
#TODO Question - How to deal with missing values of prior sucesses/failures? Delete these rows as they cannot predict next correct?
